...
//        System.out.println(part1(1));
    ...
    static String part1(int input) {
        int[] tape = Arrays.copyOf(PROGRAM, PROGRAM.length);
        int position = 0;
        String output = "";
        while (true) {
            ...
            switch (opcode % 100) {
                ...
                case 2: // multiply
                    ...
                    break;
                case 3: // read input
                    tape[tape[position + 1]] = input;
                    position += 2;
                    break;
                case 4: // write output
                    output += readValue(tape, position + 1, mode1);
                    output += "\n";
                    position += 2;
                    break;
                case 5: // jump-if-true
    ...
    private static int readValue(int[] tape, int position, int mode) {
        if (mode > 0) {
